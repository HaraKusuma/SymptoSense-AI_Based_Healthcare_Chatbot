...
template = """
You are SymptoSense AI — a friendly and helpful medical chatbot specialized in health monitoring and disease information.
...
print("SymptoSense: AI Based Hybrid RAG Chatbot is ready!")
